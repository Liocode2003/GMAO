-- ================================================================
-- DONNÉES RÉELLES - FORVIS MAZARS BURKINA FASO - 2025/2026
-- Généré automatiquement depuis Liste_du_personnel_20252026_PLATEFORME.xlsx
-- ================================================================
...
-- 3. Insérer les 50 employés réels
INSERT INTO employees (
  ...
  ('b981af9a-63ce-4814-990a-f6079a30f2aa', 'FM-004', 'Djibril', 'BAYALA', 'M'::"gender", 'djibril.bayala@forvismazars.com',
   'SENIOR_MANAGER_1'::"grade", 'CONSULTING_FA'::"service_line", 'AUDITEUR'::"employee_function", 'CDI'::"contract_type", '2024-01-10',
   '1990-01-01', 'ACTIF'::"employee_status", 22.50, NOW(), NOW()),
  ('a689a7c3-a1f4-42e7-b646-558154efbd37', 'FM-005', 'Kalifa', 'BELEM', 'M'::"gender", 'kalifa.belem@forvismazars.com',
   'ASSISTANT_MANAGER_2'::"grade", 'CONSULTING_FA'::"service_line", 'AUDITEUR'::"employee_function", 'CDI'::"contract_type", '2024-01-01',
   '1990-01-01', 'ACTIF'::"employee_status", 22.50, NOW(), NOW()),
  ('fb6870e9-389c-490d-9a8c-f65edbe18e00', 'FM-006', 'Gervais', 'BOURGOU', 'M'::"gender", 'gervais.bourgou@forvismazars.com',
   'ASSISTANT_DEBUTANT'::"grade", 'ADMINISTRATION'::"service_line", 'CHAUFFEUR'::"employee_function", 'CDI'::"contract_type", '2024-01-01',
   '1990-01-01', 'ACTIF'::"employee_status", 22.50, NOW(), NOW()),
  ...
  ('cac390bd-db49-4cdb-89ca-7d5174178e0b', 'FM-011', 'Zoenabo', 'DIPAMA', 'F'::"gender", 'zoenabo.dipama@forvismazars.com',
   'CONSULTANT'::"grade", 'CONSULTING_FA'::"service_line", 'AUDITEUR'::"employee_function", 'CDI'::"contract_type", '2024-01-01',
   '1990-01-01', 'ACTIF'::"employee_status", 22.50, NOW(), NOW()),
  ('6cf4d540-9e45-4b56-8e4f-bfcae6da1a04', 'FM-012', 'Yaya', 'GUINDO', 'M'::"gender", 'yaya.guindo@forvismazars.com',
   'CONSULTANT'::"grade", 'AUDIT_ASSURANCE'::"service_line", 'AUDITEUR'::"employee_function", 'CDI'::"contract_type", '2024-03-14',
   '1990-01-01', 'ACTIF'::"employee_status", 22.50, NOW(), NOW()),
  ('e1f7adc8-ce67-4a0f-8810-9f5e165308df', 'FM-013', 'Arsène', 'KABORE', 'M'::"gender", 'arsene.kabore@forvismazars.com',
   'SENIOR_1'::"grade", 'CONSULTING_FA'::"service_line", 'AUDITEUR'::"employee_function", 'CDI'::"contract_type", '2024-01-01',
   '1990-01-01', 'ACTIF'::"employee_status", 22.50, NOW(), NOW()),
  ...
  ('d9fcdb37-287d-4aa4-a837-152334c4c3ab', 'FM-016', 'Sié Gaël Lionel', 'KAM', 'M'::"gender", 'sie.kam@forvismazars.com',
   'SENIOR_3'::"grade", 'AUDIT_ASSURANCE'::"service_line", 'AUDITEUR'::"employee_function", 'CDI'::"contract_type", '2024-01-01',
   '1990-01-01', 'ACTIF'::"employee_status", 22.50, NOW(), NOW()),
  ...
  ('b1ebd671-cefe-409c-b60f-58ff69a4c541', 'FM-018', 'Eric Arnaud Zângbêwendé', 'KINDA', 'M'::"gender", 'eric.kinda@forvismazars.com',
   'ASSOCIE'::"grade", 'AUDIT_ASSURANCE'::"service_line", 'ASSOCIE'::"employee_function", 'CDI'::"contract_type", '2024-01-01',
   '1990-01-01', 'ACTIF'::"employee_status", 22.50, NOW(), NOW()),
  ...
  ('50b657a8-e27f-482e-84b2-1b4abbd57c84', 'FM-027', 'Amidou', 'OUEDRAOGO', 'M'::"gender", 'amidou.ouedraogo@forvismazars.com',
   'ASSOCIE'::"grade", 'CONSULTING_FA'::"service_line", 'ASSOCIE'::"employee_function", 'CDI'::"contract_type", '2024-01-01',
   '1990-01-01', 'ACTIF'::"employee_status", 22.50, NOW(), NOW()),
  ...
  ('1450c3e0-5682-4c3d-83c4-4b4a13f29366', 'FM-033', 'O. Mamounata', 'OUEDRAOGO', 'F'::"gender", 'o.ouedraogo@forvismazars.com',
   ...
   '1990-01-01', 'ACTIF'::"employee_status", 22.50, NOW(), NOW()),
  ('0232c465-e837-40d1-9261-fb17e803d031', 'FM-034', 'Soumaila', 'OUEDRAOGO', 'M'::"gender", 'soumaila.ouedraogo@forvismazars.com',
   'ASSOCIE'::"grade", 'ADMINISTRATION'::"service_line", 'ASSOCIE'::"employee_function", 'CDI'::"contract_type", '2024-01-01',
   '1990-01-01', 'ACTIF'::"employee_status", 22.50, NOW(), NOW()),
  ...
  ('5c95b6cf-d0bc-4c06-8961-8e8f29bc5301', 'FM-040', 'Issa', 'TAPSOBA', 'M'::"gender", 'issa.tapsoba@forvismazars.com',
   'ASSISTANT_DEBUTANT'::"grade", 'OUTSOURCING'::"service_line", 'AUDITEUR'::"employee_function", 'CDI'::"contract_type", '2024-01-01',
   '1990-01-01', 'ACTIF'::"employee_status", 22.50, NOW(), NOW()),
  ...
  ('da82c866-5f8f-45e4-8844-9367fee20e17', 'FM-044', 'Beya Kota Louange Mercia', 'YONABA/NAMSENEI', 'F'::"gender", 'beya.yonabanamsenei@forvismazars.com',
   'ASSISTANT_MANAGER_3'::"grade", 'AUDIT_ASSURANCE'::"service_line", 'AUDITEUR'::"employee_function", 'CDI'::"contract_type", '2024-01-01',
   '1990-01-01', 'ACTIF'::"employee_status", 22.50, NOW(), NOW()),
  ('d0b17e1a-a266-4eca-9254-c49ea8d755e6', 'FM-045', 'Windinonga Sylvain', 'ZOUNGRANA', 'M'::"gender", 'windinonga.zoungrana@forvismazars.com',
   'ASSISTANT_MANAGER_2'::"grade", 'ADMINISTRATION'::"service_line", 'MANAGER_PRINCIPAL'::"employee_function", 'CDI'::"contract_type", '2024-01-01',
   '1990-01-01', 'ACTIF'::"employee_status", 22.50, NOW(), NOW()),
  ('9e082756-8011-4a7b-8bfb-ca74c0ce253f', 'CONS-001', 'Djamila', 'KORBEOGO', 'F'::"gender", 'djamila.korbeogo@forvismazars.com',
   ...
   '1990-01-01', 'ACTIF'::"employee_status", 22.50, NOW(), NOW()),
  ('6d3b44ec-a790-4f16-ad0d-923870d5a19e', 'CONS-002', 'Andréa Evanne H. Nayibnèré', 'SAWADOGO', 'F'::"gender", 'andrea.sawadogo@forvismazars.com',
...
-- Note: birth_date fixée à 1990-01-01 (non présente dans le fichier source)
-- Note: salary non présente dans le fichier source (reste NULL)
