...
-- Équipe Admin sous FM-037 SAWADOGO SOME (sans FM-045 qui est au-dessus)
UPDATE employees SET manager_id='3c49813b-a779-44a2-ae33-dc587ac2a01f'
WHERE matricule IN ('FM-006','FM-014','FM-020','FM-025','FM-041');
-- FM-007 et FM-050 (Tax & Legal) sous FM-018 KINDA (Associé Audit/Tax)
UPDATE employees SET manager_id='b1ebd671-cefe-409c-b60f-58ff69a4c541'
WHERE matricule IN ('FM-007','FM-050');
...
VALUES
  ...
  ('50b657a8-e27f-482e-84b2-1b4abbd57c84','PLANIFIE','2025-08-25','2025-09-05',10,2025,'APPROUVE','a0000001-0000-0000-0000-000000000001',NOW(),'a0000001-0000-0000-0000-000000000001'),
...
VALUES
  ...
  ('50b657a8-e27f-482e-84b2-1b4abbd57c84',4000000,4200000,'2025-01-01','Révision annuelle','a0000001-0000-0000-0000-000000000001'),
...
INSERT INTO trainings (id, type, title, date, location, duration_hours, trainer, budget, created_by) VALUES
  ...
  ('c0000003-0000-0000-0000-000000000003','INTERNE',  'Procédures internes Forvis Mazars BF',            '2024-06-10','Ouagadougou', 4,  'Catherine Sawadogo-Somé',        0,       'a0000001-0000-0000-0000-000000000001'),
  ('c0000004-0000-0000-0000-000000000004','INTRA',    'Fiscalité des entreprises BF — mise à jour 2024', '2024-09-09','Ouagadougou', 8,  'Direction Générale des Impôts',   350000,  'a0000001-0000-0000-0000-000000000001'),
  ('c0000005-0000-0000-0000-000000000005','GROUPE',   'Lutte anti-blanchiment (LAB/LFT)',                '2024-11-18','Dakar',       8,  'Formateur Compliance Group',      650000,  'a0000001-0000-0000-0000-000000000001'),
  ('c0000006-0000-0000-0000-000000000006','INTERNE',  'Soft skills — communication client',              '2025-01-20','Ouagadougou', 4,  'Coach externe',                   200000,  'a0000001-0000-0000-0000-000000000001'),
  ('c0000007-0000-0000-0000-000000000007','GROUPE',   'OHADA — Actualités SYSCOHADA révisé',             '2025-03-10','Ouagadougou', 8,  'OHADA Secrétariat Permanent',     400000,  'a0000001-0000-0000-0000-000000000001'),
  ('c0000008-0000-0000-0000-000000000008','AOC',      'Leadership & Management pour managers',           '2025-05-05','Lomé',       16,  'HEC Paris Executive Education',  1500000,  'a0000001-0000-0000-0000-000000000001'),
  ('c0000009-0000-0000-0000-000000000009','INTERNE',  'Cybersécurité & Protection des données',          '2025-07-14','Ouagadougou', 4,  'Équipe IT Forvis Mazars',         0,       'a0000001-0000-0000-0000-000000000001'),
  ('c0000010-0000-0000-0000-000000000010','INTRA',    'Comptabilité des ONG et projets bailleurs',       '2025-09-08','Ouagadougou', 8,  'Consultant indépendant',          450000,  'a0000001-0000-0000-0000-000000000001'),
  ('c0000011-0000-0000-0000-000000000011','GROUPE',   'Transformation digitale & IA en audit',           '2025-11-17','Casablanca',  16, 'Forvis Mazars Global Learning',  1800000,  'a0000001-0000-0000-0000-000000000001'),
  ('c0000012-0000-0000-0000-000000000012','INTERNE',  'Onboarding nouveaux collaborateurs 2026',         '2026-01-13','Ouagadougou', 4,  'DRH Forvis Mazars BF',            0,       'a0000001-0000-0000-0000-000000000001'),
  ('c0000013-0000-0000-0000-000000000013','INTRA',    'Excel avancé & Power BI pour auditeurs',          '2026-02-24','Ouagadougou', 8,  'Formateur Microsoft Partner',     380000,  'a0000001-0000-0000-0000-000000000001'),
  ('c0000014-0000-0000-0000-000000000014','AOC',      'Droit des affaires OHADA — Acte uniforme révisé', '2026-04-07','Abidjan',     8,  'Cabinet Juriste UEMOA',            750000,  'a0000001-0000-0000-0000-000000000001');

-- Participants formations
INSERT INTO training_participants (training_id, employee_id) VALUES
-- Formation IFRS 16 (2024)
  ('c0000001-0000-0000-0000-000000000001','eae9d8bf-4b20-4950-a68d-6bf59a75e600'),
  ('c0000001-0000-0000-0000-000000000001','f5d8a290-3197-4c29-a3ee-b8a8618f3bb2'),
  ('c0000001-0000-0000-0000-000000000001','fa07f8e1-cae0-41b4-b3ba-dc18212d3eb8'),
  ('c0000001-0000-0000-0000-000000000001','db254baf-ffb8-43e5-938b-fa9059788856'),
  ('c0000001-0000-0000-0000-000000000001','0a319971-1084-4029-812f-8c25bacced55'),
  ('c0000001-0000-0000-0000-000000000001','88dc1fba-50a7-4707-926d-69871cb44665'),
  ('c0000001-0000-0000-0000-000000000001','250bd9bf-80ca-485e-a417-8782805779d2'),
-- Formation Audit Avancé AOC (2024)
  ('c0000002-0000-0000-0000-000000000002','fa07f8e1-cae0-41b4-b3ba-dc18212d3eb8'),
  ('c0000002-0000-0000-0000-000000000002','db254baf-ffb8-43e5-938b-fa9059788856'),
  ('c0000002-0000-0000-0000-000000000002','da82c866-5f8f-45e4-8844-9367fee20e17'),
  ('c0000002-0000-0000-0000-000000000002','a3454457-bc1f-4be4-9153-369ca3949772'),
  ('c0000002-0000-0000-0000-000000000002','42d953ac-bdd2-426c-885b-9a9bf5257746'),
-- Formation Procédures internes (2024)
  ('c0000003-0000-0000-0000-000000000003','f74b6dc7-ddff-49ba-aeba-087c9c6ac161'),
  ('c0000003-0000-0000-0000-000000000003','068a9674-5b27-461c-ab0f-ff4db8f516f4'),
  ('c0000003-0000-0000-0000-000000000003','571c2af2-ddac-415e-b05d-802b6167dea0'),
  ('c0000003-0000-0000-0000-000000000003','b9fbca80-5755-4eac-a865-51b2027ffe6e'),
  ('c0000003-0000-0000-0000-000000000003','5c95b6cf-d0bc-4c06-8961-8e8f29bc5301'),
  ('c0000003-0000-0000-0000-000000000003','f3a214e0-69c3-4dca-8892-a13ec01efc47'),
-- Formation Fiscalité (2024)
  ('c0000004-0000-0000-0000-000000000004','8ac6a425-564e-421b-803d-0ec8eff6d4f1'),
  ('c0000004-0000-0000-0000-000000000004','cac390bd-db49-4cdb-89ca-7d5174178e0b'),
  ('c0000004-0000-0000-0000-000000000004','b981af9a-63ce-4814-990a-f6079a30f2aa'),
  ('c0000004-0000-0000-0000-000000000004','e1f7adc8-ce67-4a0f-8810-9f5e165308df'),
  ('c0000004-0000-0000-0000-000000000004','19239447-8f42-4512-92b1-cde30d8677ab'),
-- Formation LAB/LFT (2024)
  ('c0000005-0000-0000-0000-000000000005','b1ebd671-cefe-409c-b60f-58ff69a4c541'),
  ('c0000005-0000-0000-0000-000000000005','50b657a8-e27f-482e-84b2-1b4abbd57c84'),
  ('c0000005-0000-0000-0000-000000000005','0ce23c14-8a91-4f02-8a69-ea409b66d204'),
  ('c0000005-0000-0000-0000-000000000005','fa07f8e1-cae0-41b4-b3ba-dc18212d3eb8'),
  ('c0000005-0000-0000-0000-000000000005','db254baf-ffb8-43e5-938b-fa9059788856'),
-- Soft skills (2025)
  ('c0000006-0000-0000-0000-000000000006','eae9d8bf-4b20-4950-a68d-6bf59a75e600'),
  ('c0000006-0000-0000-0000-000000000006','0934abd4-7be5-4767-a3c9-134b68890a24'),
  ('c0000006-0000-0000-0000-000000000006','42d953ac-bdd2-426c-885b-9a9bf5257746'),
  ('c0000006-0000-0000-0000-000000000006','a3454457-bc1f-4be4-9153-369ca3949772'),
  ('c0000006-0000-0000-0000-000000000006','1450c3e0-5682-4c3d-83c4-4b4a13f29366'),
-- OHADA (2025)
  ('c0000007-0000-0000-0000-000000000007','8ac6a425-564e-421b-803d-0ec8eff6d4f1'),
  ('c0000007-0000-0000-0000-000000000007','fc122994-8c07-46e8-ab12-7471f35c9665'),
  ('c0000007-0000-0000-0000-000000000007','32fa4a31-2d72-4b17-8877-e1655db1479b'),
  ('c0000007-0000-0000-0000-000000000007','395c75a0-804e-42ef-b80e-d0424078772a'),
  ('c0000007-0000-0000-0000-000000000007','9e082756-8011-4a7b-8bfb-ca74c0ce253f'),
-- Leadership Managers (2025)
  ('c0000008-0000-0000-0000-000000000008','fa07f8e1-cae0-41b4-b3ba-dc18212d3eb8'),
  ('c0000008-0000-0000-0000-000000000008','db254baf-ffb8-43e5-938b-fa9059788856'),
  ('c0000008-0000-0000-0000-000000000008','da82c866-5f8f-45e4-8844-9367fee20e17'),
  ('c0000008-0000-0000-0000-000000000008','b981af9a-63ce-4814-990a-f6079a30f2aa'),
  ('c0000008-0000-0000-0000-000000000008','3c49813b-a779-44a2-ae33-dc587ac2a01f'),
  ('c0000008-0000-0000-0000-000000000008','1450c3e0-5682-4c3d-83c4-4b4a13f29366'),
-- Cybersécurité (2025)
  ('c0000009-0000-0000-0000-000000000009','d0b17e1a-a266-4eca-9254-c49ea8d755e6'),
  ('c0000009-0000-0000-0000-000000000009','ab1e9ac7-612a-4d54-9272-e3db401f6109'),
  ('c0000009-0000-0000-0000-000000000009','eb7948d3-9f0d-4f6b-ac97-26a931e829f9'),
  ('c0000009-0000-0000-0000-000000000009','9458ca32-a723-4faa-ab58-bfc14fb7f4c0'),
  ('c0000009-0000-0000-0000-000000000009','fb6870e9-389c-490d-9a8c-f65edbe18e00'),
-- Comptabilité ONG (2025)
  ('c0000010-0000-0000-0000-000000000010','fc122994-8c07-46e8-ab12-7471f35c9665'),
  ('c0000010-0000-0000-0000-000000000010','32fa4a31-2d72-4b17-8877-e1655db1479b'),
  ('c0000010-0000-0000-0000-000000000010','5c95b6cf-d0bc-4c06-8961-8e8f29bc5301'),
  ('c0000010-0000-0000-0000-000000000010','395c75a0-804e-42ef-b80e-d0424078772a'),
  ('c0000010-0000-0000-0000-000000000010','6d3b44ec-a790-4f16-ad0d-923870d5a19e'),
-- IA & Transformation digitale (2025)
  ('c0000011-0000-0000-0000-000000000011','b1ebd671-cefe-409c-b60f-58ff69a4c541'),
  ('c0000011-0000-0000-0000-000000000011','50b657a8-e27f-482e-84b2-1b4abbd57c84'),
  ('c0000011-0000-0000-0000-000000000011','0ce23c14-8a91-4f02-8a69-ea409b66d204'),
  ('c0000011-0000-0000-0000-000000000011','fa07f8e1-cae0-41b4-b3ba-dc18212d3eb8'),
  ('c0000011-0000-0000-0000-000000000011','db254baf-ffb8-43e5-938b-fa9059788856'),
-- Onboarding 2026
  ('c0000012-0000-0000-0000-000000000012','f3a214e0-69c3-4dca-8892-a13ec01efc47'),
  ('c0000012-0000-0000-0000-000000000012','fec5f2fd-fff6-4890-b6dc-92602c29289b'),
  ('c0000012-0000-0000-0000-000000000012','589ef44d-7395-4f84-a0b0-260ec5c36afe'),
  ('c0000012-0000-0000-0000-000000000012','50800967-ea50-414a-afa4-0d255854e1bd'),
  ('c0000012-0000-0000-0000-000000000012','c5f2bb51-0c0e-4c36-aa67-3c877fab5c6d'),
-- Excel/Power BI (2026)
  ('c0000013-0000-0000-0000-000000000013','eae9d8bf-4b20-4950-a68d-6bf59a75e600'),
  ('c0000013-0000-0000-0000-000000000013','e486d0de-c936-4040-8a91-cd995928bbbe'),
  ('c0000013-0000-0000-0000-000000000013','83e730ca-4b1c-42f6-b43c-08130dadde67'),
  ('c0000013-0000-0000-0000-000000000013','71ad499c-e1c9-46fe-acc0-af4525cb5494'),
  ('c0000013-0000-0000-0000-000000000013','0934abd4-7be5-4767-a3c9-134b68890a24'),
  ('c0000013-0000-0000-0000-000000000013','d9fcdb37-287d-4aa4-a837-152334c4c3ab'),
-- Droit OHADA 2026
  ('c0000014-0000-0000-0000-000000000014','8ac6a425-564e-421b-803d-0ec8eff6d4f1'),
  ('c0000014-0000-0000-0000-000000000014','bcd1a32a-4b83-484c-a3d8-93aa4647734f'),
  ('c0000014-0000-0000-0000-000000000014','6cf4d540-9e45-4b56-8e4f-bfcae6da1a04');
...
-- 2025 — AO gagnés
  ...
  ('APPEL_OFFRE','AO-2025-002','Assistance technique budgétisation axée résultats','PNUD Burkina','2025-03-17','CONSULTING_FA','50b657a8-e27f-482e-84b2-1b4abbd57c84','GAGNE',55000000,'2025-05-01','2026-04-30','a0000001-0000-0000-0000-000000000001'),
...
-- 2026 — En cours et récents
  ...
  ('APPEL_OFFRE','AO-2026-002','Assistance maîtrise ouvrage réforme GFP','Ministère des Finances','2026-04-28','CONSULTING_FA','50b657a8-e27f-482e-84b2-1b4abbd57c84','EN_COURS',NULL,NULL,NULL,'a0000001-0000-0000-0000-000000000001'),
